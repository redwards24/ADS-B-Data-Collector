...
public class GeoplotModel 
{
	...
	private final VisualModel parent;
	
	
	 
	public GeoplotModel(final VisualModel parent)
	{
		this.parent = parent;
	...
	private void geoplot()
	{
		...
		final String title = parent.titleField.getText();
		final String subtitle = parent.subtitleField.getText();
